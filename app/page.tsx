  ...
  return (
    <main className="animate-content-main ">
      <aside className="pl-10 mb-10 lg:ml-28 animate-content-second">
        <h2 className="text-md w-64 animate-content-second dark:text-blue-700 dark:hover:text-pink-300 text-pink-500 hover:text-sky-600 duration-300 cursor-pointer font-bold">HELLO, MY NAME IS MARCONDES.</h2>
        <p className="text-sm w-[60%] sm:text-md sm:w-[50%]">
          <strong className="text-2xl sm:text-3xl ">
            I make websites.
          </strong> <br />
          I'm front-end develop in Brazil. <br />
      ...
      <Link className="" href="/contact">
        ...
        <button className="dark:hover:text-pink-300 font-semibold dark:text-blue-600 text-black hover:text-blue-400 ml-10 duration-300 w-20 cursor-pointer">Interested?</button>
      </Link>
    </main>
  );
}