            ...
            <div className="h-[70%]">
                <div className="justify-center flex space-x-8 flex-wrap">
                    <a href="https://github.com/mascou9090">
                        <img className="w-10 h-10 hover:opacity-50 duration-300 cursor-pointer" src={Github.src} alt="Github icon Navgation" />
                    </a>
                    <a href="https://www.linkedin.com/in/marcondes-pinheiro-48aa231ab/">
                        <img className="w-10 h-10 hover:opacity-50 duration-300 cursor-pointer" src={Linkedin.src} alt="Github icon Navgation" />
                    </a>
                    <a href="https://www.instagram.com/marcondes_soeu/">
                        <img className="w-10 h-10 hover:opacity-50 duration-300 cursor-pointer" src={Instagram.src} alt="Github icon Navgation" />
                    </a>
                    <a href="mailto:marcondessam@gmail.com">
                        <img className="w-10 h-10 hover:opacity-50 duration-300 cursor-pointer" src={Email.src} alt="Github icon Navgation" />
                    </a>
                    <a href="https://wa.me//5585999504253?text=Ola%20Dev%20Marcondes%20venho%20direcionado%20do%20seu%20site!">
                        <img className="w-10 h-10 hover:opacity-50 duration-300 cursor-pointer" src={Whatsap.src} alt="Github icon Navgation" />
                    </a>
                </div>
                <div className="p-10 flex flex-col text-center justify-center">
                    ...
                    <p className="text-md">Caso queira dar uma olhada nos meus códigos, também deixei meu <a className="hover:opacity-40 font-bold duration-300" href="https://github.com/mascou9090">Github</a>.</p>
                </div>
